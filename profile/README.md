...
| Repo | Description |
|------|-------------|
| [octomil-python](https://github.com/octomil/octomil-python) | Python SDK & CLI |
| [octomil-ios](https://github.com/octomil/octomil-ios) | iOS SDK (Swift + CoreML) |
| [octomil-android](https://github.com/octomil/octomil-android) | Android SDK (Kotlin + TFLite) |

### Links

- [octomil.com](https://octomil.com)
